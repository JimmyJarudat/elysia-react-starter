const RequestLogsPage = () => (
  <section className="grid gap-5">
    <div>
      ...
      <h1 className="text-3xl font-semibold tracking-normal text-slate-900 dark:text-slate-50">Request Logs</h1>
    </div>
    <article className="rounded-lg border border-theme bg-light-background-card p-6 shadow-soft dark:bg-dark-background-card">
      <p className="text-slate-500 dark:text-slate-400">บันทึกการเรียกใช้งาน API, Status Code, Response Time, IP Address — ยังไม่ได้พัฒนา</p>
    </article>
  </section>
);
