...
const UserDropdown = ({ onClose }: UserDropdownProps) => {
  const itemClass =
    "flex items-center gap-2 rounded-md border-0 bg-transparent px-3 py-2 text-left text-sm text-light-text transition-colors hover:bg-ocean-50/50 hover:text-light-primary dark:text-dark-text dark:hover:bg-slate-blue-800/40 dark:hover:text-dark-primary";
