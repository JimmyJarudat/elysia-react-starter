...
const permissions = [
  ...
  ["settings.integrations.ldap.read",       "Settings Integrations LDAP Read",       "settings.integrations.ldap",     "read"],
  ["settings.integrations.ldap.update",     "Settings Integrations LDAP Update",     "settings.integrations.ldap",     "update"],
...
const apiRoutes = [
  ...
  ["GET",    "/api/system-setting/general/organization-support",                "settings.general.organization.read"],
  ["PUT",    "/api/system-setting/general/organization-support",                "settings.general.organization.update"],
  ["GET",    "/api/system-setting/general/registration",                        "settings.general.registration.read"],
  ...
  ["GET",    "/api/system-setting/security/cors",                                "settings.security.cors.read"],
  ["PUT",    "/api/system-setting/security/cors",                                "settings.security.cors.update"],
  ["GET",    "/api/system-setting/integrations/smtp",                                "settings.integrations.smtp.read"],
  ["PUT",    "/api/system-setting/integrations/smtp",                                "settings.integrations.smtp.update"],
  ["POST",   "/api/system-setting/integrations/smtp/test",                           "settings.integrations.smtp.update"],
  ["POST",   "/api/system-setting/integrations/smtp/send-test",                      "settings.integrations.smtp.update"],
  ["GET",    "/api/system-setting/integrations/redis",                               "settings.integrations.redis.read"],
  ["PUT",    "/api/system-setting/integrations/redis",                               "settings.integrations.redis.update"],
  ["POST",   "/api/system-setting/integrations/redis/test",                          "settings.integrations.redis.update"],
  ["GET",    "/api/system-setting/integrations/redis/status",                        "settings.integrations.redis.read"],
  ["GET",    "/api/system-setting/integrations/redis/keys",                          "settings.integrations.redis.read"],
  ["POST",   "/api/system-setting/integrations/redis/key",                           "settings.integrations.redis.read"],
  ["DELETE", "/api/system-setting/integrations/redis/key",                           "settings.integrations.redis.update"],
  ["POST",   "/api/system-setting/integrations/redis/clear",                         "settings.integrations.redis.update"],
  ...
  ["GET",    "/api/system-setting/integrations/ldap/status",                         "settings.integrations.ldap.read"],
  ...
  ["PUT",    "/api/system-setting/general/maintenance",                         "settings.general.maintenance.update"],
...
const systemConfigs = [
  ...
  ["ldap_enabled",                             "false",        "Enable LDAP user lookup",                                             "LDAP",            "LDAP Enabled",                             "BOOLEAN", false],
  ["ldap_url",                                 "ldap://ldap.example.com:389", "LDAP server URL",                                            "LDAP",            "LDAP URL",                                 "STRING",  false],
  ["ldap_encryption",                          "starttls",     "LDAP encryption mode: none, starttls, or ldaps",                      "LDAP",            "LDAP Encryption",                          "STRING",  false],
  ["ldap_bind_dn",                             "cn=admin,dc=example,dc=com", "LDAP bind distinguished name",                              "LDAP",            "LDAP Bind DN",                             "STRING",  false],
  ...
  ["resources:department:Account",             "IT",      "Department resource imported from LDAP",                              "DEPARTMENT",      "Department: Account",                     "STRING",  false],
  ["resources:group:profile",                  "Group Jimmy",      "Group resource imported from LDAP domain",                            "GROUPNAME",       "Group: profile",                          "STRING",  false],
  ...
  ["storage_ftp_password",                     "",             "FTP password. Set this in the database or settings UI.",              "STORAGE",         "FTP Password",                             "STRING",  true],
  ["storage_ftp_port",                         "21",           "FTP server port",                                                     "STORAGE",         "FTP Port",                                 "NUMBER",  false],
  ["storage_ftp_secure",                       "false",        "Use explicit FTPS/TLS for FTP storage",                               "STORAGE",         "FTP Secure",                               "BOOLEAN", false],
  ["storage_ftp_username",                     "",             "FTP username",                                                         "STORAGE",         "FTP Username",                             "STRING",  false],
  ...
  ["storage_sftp_base_path",                   "",             "Base path inside SFTP server",                                        "STORAGE",         "SFTP Base Path",                           "STRING",  false],
  ["storage_sftp_host",                        "",             "SFTP server host",                                                    "STORAGE",         "SFTP Host",                                "STRING",  false],
  ["storage_sftp_password",                    "",             "SFTP password. Set this in the database or settings UI.",             "STORAGE",         "SFTP Password",                            "STRING",  true],
  ["storage_sftp_port",                        "22",           "SFTP server port",                                                    "STORAGE",         "SFTP Port",                                "NUMBER",  false],
  ["storage_sftp_username",                    "",             "SFTP username",                                                        "STORAGE",         "SFTP Username",                            "STRING",  false],
