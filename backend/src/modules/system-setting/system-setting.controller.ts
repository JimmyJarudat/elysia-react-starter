...
export const systemSettingController = new Elysia({ prefix: "/system-setting" })
  .group("/general", (app) => app
    .get("/identity", async () => GeneralSettingService.getIdentity())
    .put("/identity", async ({ body, request }) => GeneralSettingService.updateIdentity({
      ...body,
    ...
    .get("/organization-support", async () => GeneralSettingService.getOrganizationSupport())
    .put("/organization-support", async ({ body, request }) => GeneralSettingService.updateOrganizationSupport({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .get("/registration/status", async () => GeneralSettingService.getRegistrationApproval())
    .get("/registration", async () => GeneralSettingService.getRegistrationApproval())
    .put("/registration", async ({ body, request }) => GeneralSettingService.updateRegistrationApproval({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .get("/notification-sound", async () => GeneralSettingService.getNotificationSound())
    .put("/notification-sound", async ({ body, request }) => GeneralSettingService.updateNotificationSound({
      sound: body.sound,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .delete("/notification-sound", async ({ request }) => GeneralSettingService.deleteNotificationSound(getValidUserId(request)))
    .get("/regional/status", async () => GeneralSettingService.getRegional())
    .get("/regional", async () => GeneralSettingService.getRegional())
    .put("/regional", async ({ body, request }) => GeneralSettingService.updateRegional({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .get("/maintenance/status", async () => GeneralSettingService.getMaintenance())
    .get("/maintenance", async () => GeneralSettingService.getMaintenance())
    .put("/maintenance", async ({ body, request }) => GeneralSettingService.updateMaintenance({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
  ...
  .group("/security", (app) => app
    ...
    .get("/ip-blocklist", async () => SecuritySettingService.getIpBlocklist())
    .post("/ip-blocklist", async ({ body, request }) => SecuritySettingService.addIpBlocklist(
      body.ipAddress,
      body.reason,
    ...
    .get("/cors", async () => SecuritySettingService.getCorsSettings())
    .put("/cors", async ({ body, request }) => SecuritySettingService.updateCorsSettings(
      body.origins,
      getValidUserId(request),
    ), {
      body: t.Object({
  ...
  .group("/integrations", (app) => app
    ...
    .post("/smtp/test", async ({ body }) => IntegrationSettingService.testSmtpConnection(body), {
      body: t.Object({
        enabled: t.Optional(t.Boolean()),
        host: t.Optional(t.String()),
        port: t.Optional(t.Number()),
    ...
    .post("/smtp/send-test", async ({ body }) => IntegrationSettingService.sendSmtpTestEmail(body.to), {
      body: t.Object({
        to: t.String(),
      }),
    })
    .get("/redis", async () => IntegrationSettingService.getRedisSettings())
    .put("/redis", async ({ body, request }) => IntegrationSettingService.updateRedisSettings({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .post("/redis/test", async ({ body }) => IntegrationSettingService.testRedisConnection(body), {
      body: t.Object({
        enabled: t.Optional(t.Boolean()),
        host: t.Optional(t.String()),
        port: t.Optional(t.Number()),
    ...
    .get("/redis/status", async () => IntegrationSettingService.getRedisStatus())
    .get("/redis/keys", async ({ query }) => IntegrationSettingService.listRedisKeys(query.group), {
      query: t.Object({
        group: t.Optional(t.String()),
      }),
    })
    .post("/redis/key", async ({ body }) => IntegrationSettingService.getRedisKeyValue(body.key), {
      body: t.Object({
        key: t.String(),
      }),
    })
    .delete("/redis/key", async ({ body, request }) => IntegrationSettingService.deleteRedisKey(
      body.key,
      getValidUserId(request),
    ), {
      body: t.Object({
    ...
    .post("/redis/clear", async ({ body, request }) => IntegrationSettingService.clearRedisKeys(
      body.group,
      getValidUserId(request),
    ), {
      body: t.Object({
    ...
    .get("/storage", async () => IntegrationSettingService.getStorageSettings())
    .put("/storage", async ({ body, request }) => IntegrationSettingService.updateStorageSettings({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .post("/storage/test", async ({ body, request }) => IntegrationSettingService.testStorageConnection({
      ...body,
      userId: getValidUserId(request),
    }), {
      body: t.Object({
    ...
    .get("/storage/migration/status", async () => IntegrationSettingService.getStorageMigrationStatus())
    .get("/storage/migration/scan", async ({ request }) => IntegrationSettingService.scanStorageMigration({
      userId: getValidUserId(request),
    }))
    ...
    .post("/storage/migration/cleanup", async ({ body, request }) => IntegrationSettingService.cleanupStorageMigration({
