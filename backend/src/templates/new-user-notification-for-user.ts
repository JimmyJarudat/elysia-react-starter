...
export class WelcomeEmailService {
  ...
  static async sendWelcomeEmail(userData: WelcomeEmailData): Promise<{
    ...
    try {
      ...
      const emailSubject = `🎉 ยินดีต้อนรับสู่ ${templateConfig.appName} - ${userData.username}`;
      const emailBody = this.generateWelcomeEmailTemplate(userData, templateConfig);
  ...
  private static generateWelcomeEmailTemplate(userData: WelcomeEmailData, config: EmailTemplateConfig): string {
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; max-width: 600px;">
                    ...
                    <tr>
                        <td style="background-color: #667eea; padding: 40px 30px; text-align: center;">
                            ...
                            <p style="margin: 15px 0 0 0; color: #ffffff; font-size: 16px;">คุณได้รับสิทธิ์เข้าใช้งาน ${config.appName} แล้ว</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #333333; font-size: 15px; line-height: 1.8;">
                                ยินดีต้อนรับเข้าสู่ระบบ <strong>${config.appName}</strong> บัญชีของคุณได้รับการอนุมัติและพร้อมใช้งานแล้ว
                            </p>
                                    ...
                                    <td style="border-top: 2px solid #e9ecef; padding-top: 25px;">
                                        ...
                                        <table width="100%" cellpadding="8" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #495057; font-size: 13px; line-height: 1.6;">
                                                    <strong>เริ่มใช้งาน</strong> ระบบ ${config.appName} ได้เลย!
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
  ...
  private static async sendEmail(
    ...
    try {
      ...
      const mailOptions = {
        ...
        subject: subject,
        html: htmlContent,
        text: `ยินดีต้อนรับสู่ ${config.appName} - ${recipientName}`
      };
